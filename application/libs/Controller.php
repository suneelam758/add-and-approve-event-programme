...
class Controller
{
    ...
    public function loadModel($name)
    {
        ...
        if (file_exists($path)) { //echo "w";exit;
	...
	/**
     * loads the model permission with the given model id.
     * @param $modid int model id, $type integer permission 
	 * type 1,2,3,4(view, edit, delete, add) of the model
     */
